...
const trackPageLoad = () => {
  posthog.capture('$pageview', {
    ...
    page_title: 'EchoLLM - Local AI Platform',
...
const ProviderLogos = () => {
  ...
  const providerImages = [
    ...
    'https://img.icons8.com/F2F2F2/48/grok--v1.png',
    'https://img.icons8.com/color/48/nvidia.png',
    'https://img.icons8.com/softteal/24/chatgpt.png',
    'https://img.icons8.com/fluency/48/claude.png',
    'https://img.icons8.com/fluency/48/gemini-ai.png',
    'https://img.icons8.com/fluency/48/meta.png',
...
export default function EchoLLMLanding() {
  ...
  // Initialize PostHog and track page load
  useEffect(() => {
    initPostHog();

    // Track page load after PostHog is initialized
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">Your data never leaves your machine. No cloud dependencies, no data collection.</CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">Access models from OpenAI, Anthropic, Google, Meta, and more through one interface.</CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">Built for Linux with native performance optimizations and efficient resource usage.</CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">Tools, and extensive documentation for seamless integration.</CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">No / minimal network latency. Instant responses with local model inference.</CardDescription>
                </CardHeader>
              </Card>
              <Card className="bg-slate-800/50 border-slate-700">
                <CardHeader>
                  ...
                  <CardDescription className="text-slate-300">Switch between models seamlessly with our intuitive chat interface.</CardDescription>
                </CardHeader>
              </Card>
            </div>
          </div>
        ...
        <section ref={downloadRef} id="download" className="py-20 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-300">Download EchoLLM for your Linux distribution and start using AI locally.</p>
            </div>
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                ...
                <CardContent className="space-y-4">
                  <div className="bg-slate-900 p-4 rounded-lg font-mono text-sm">
                    ...
                    <div className="text-green-400">wget https://github.com/ThatLinuxGuyYouKnow/EchoLLM/releases/download/alpha/echo_llm-1.0.0+1-linux.deb</div>
                    <div className="text-green-400">sudo dpkg -i echo_llm-1.0.0+1-linux.deb</div>
                  </div>
                  <Button
              ...
              <Card className="bg-slate-800/50 border-slate-700">
                ...
                <CardContent className="space-y-4">
                  ...
                  <Button
                    ...
                    onClick={handleAppImageDownload}
                    asChild
                  >
                    <Link
                      href="https://releases.echollm.dev/EchoLLM.AppImage"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <Download className="w-4 h-4 mr-2" />
        ...
        <section ref={aboutRef} id="about" className="py-20 px-4">
          <div className="container mx-auto max-w-4xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-300">EchoLLM is designed from the ground up to give you complete control over your AI interactions.</p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300">Audit the code, contribute features, and be part of the community.</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                    <Image src={'/icon.png'} alt='Logo' width={60} height={60} className="rounded-md" />
                  </div>
                  <span className="text-xl font-bold">EchoLLM</span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-400">
                  ...
                  <li><Link href="https://github.com/ThatLinuxGuyYouKnow/EchoLLM" className="hover:text-white transition-colors">Documentation</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold mb-4">Community</h4>
                <ul className="space-y-2 text-slate-400">
                  <li><Link href="https://github.com/ThatlinuxGuyYouKnow/echollm" target="_blank" className="hover:text-white transition-colors">GitHub</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-400">
                  <li><Link href="https://github.com/ThatLinuxGuyYouKnow/EchoLLM" className="hover:text-white transition-colors">About</Link></li>
